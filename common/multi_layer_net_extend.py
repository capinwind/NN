...
class MultiLayerNetExtend:
    ...
    def __init__(self, input_size, hidden_size_list, output_size,
        ...
        # KuYa: Change activation from relu to sigmoid.
        ...
        self.last_layer = IdentityWithLoss()  #for regression
        #self.last_layer = SoftmaxWithLoss()  #for classification
